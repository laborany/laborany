...
export function StorageSection({
  ...
  return (
    <div className="space-y-6">
      ...
      <SettingsCard title="媒体素材存储" description="配置 TOS，用于视频生成时处理中转本地参考素材。">
        {renderFields(storageKeys, fieldOpts)}
        <div className="mt-3 rounded border border-blue-300/60 bg-blue-50 p-3 text-xs text-blue-900">
          本地视频 reference 会先上传到 TOS，再以公开 URL 或临时签名 URL 传给视频生成服务。未配置时，原有文本生成、图片参考和旧 Agent 流程不受影响。
        </div>
      </SettingsCard>
    </div>
  )
