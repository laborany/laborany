...
**Every animation in this README was made by laborany-design itself.** No Figma, no After Effects — just a sentence + skill run. Next product launch needs a promo video? You can make it too.

```
npx skills add alchaincyf/laborany-design
```
...
<p align="center"><sub>▲ 10-second hero animation showing what laborany-design does (<a href="https://github.com/alchaincyf/huashu-design/releases/download/v2.0/hero-animation-v10-en.mp4">download MP4</a> if autoplay doesn't work)</sub></p>
...
<p align="center">
  <a href="https://star-history.com/#alchaincyf/laborany-design&Date">
    <img src="https://api.star-history.com/svg?repos=alchaincyf/laborany-design&type=Date" alt="laborany-design Star History" width="80%">
  </a>
</p>
...
| WeChat Official Account |  | Search "" in WeChat |
